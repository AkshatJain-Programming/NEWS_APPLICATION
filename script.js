...
const light_mode=document.querySelector('.lightMode');
const body=document.querySelector('body');
const navBar=document.querySelector('nav');
const inputBar=document.querySelector('.news-input');
...
dark_mode.addEventListener('click',()=>{
    ...
    inputBar.classList.remove('dark');
    srcBtn.classList.remove('dark');
...
light_mode.addEventListener('click',()=>{
    ...
    inputBar.classList.add('dark');
    srcBtn.classList.add('dark');
    // card2.classList.add('dark');
